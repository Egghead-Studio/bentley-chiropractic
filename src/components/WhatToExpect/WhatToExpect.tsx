      ...
      <div className={'flex flex-col xl:flex-row gap-4 xl:gap-8'}>
        <div className={'w-full'}>
          <Card
            ...
            bodyText={'Dr. Bentley will get a comprehensive medical history. The goal here is to understand any current or past health concerns along with any major events so that we have a precise view of how your body is functioning.'}
