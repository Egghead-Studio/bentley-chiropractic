  ...
  return (
    <div className={'flex w-page gap-12 items-center py-12 lg:py-24'}>
      <div className={'w-5/12 hidden lg:flex'}>
        <Image className={'shadow-xl rounded-lg'} src={'/matt-bentley-doctor-of-chiropractic.jpeg'} alt={'Dr. Matthew Bentley'} width={500} height={500} />
      </div>
      <div className={'flex flex-col gap-4 lg:w-7/12'}>
        ...
        <div className={'flex w-full mb-4 md:justify-center m lg:hidden'}>
          <Image className={'shadow-xl rounded-lg'} src={'/matt-bentley-doctor-of-chiropractic-small.jpg'} alt={'Dr. Matthew Bentley'} width={500} height={500} />
        </div>
